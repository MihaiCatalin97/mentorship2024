...
//    }
    ...
    public NotificationEntity create(NotificationEntity notification) {
        jdbcTemplate.update("INSERT INTO notifications (user_id, email, marked_as_read, created_at, payload, type) " +
                "VALUES (?,?,?,?,?,?)",
                notification.getUserId(),notification.getEmail(), notification.getMarkedAsRead(), notification.getCreatedAt(), String.valueOf(notification.getPayload()),  String.valueOf(notification.getType()));
        return notification;
    }
